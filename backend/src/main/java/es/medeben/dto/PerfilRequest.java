...
public record PerfilRequest(
        ...
        @Size(max = 60, message = "no puede pasar de 60 caracteres") String provincia,
        @NotBlank(message = "no puede faltar")
        @Size(max = 30, message = "no puede pasar de 30 caracteres") String subsector,
        @Size(max = 40, message = "no puede pasar de 40 caracteres") String puestoId,
        ...
        Map<@NotNull(message = "no puede faltar") @Size(max = 40, message = "no puede pasar de 40 caracteres") String,
                @NotNull(message = "no puede faltar") @Size(max = 400, message = "no puede pasar de 400 caracteres") String> dimensiones,

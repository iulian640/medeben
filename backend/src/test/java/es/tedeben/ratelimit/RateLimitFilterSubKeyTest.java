...
@TestPropertySource(properties = {
        ...
        "tedeben.rate-limit.auth.capacidad=100",
        "tedeben.rate-limit.auth.recarga-por-minuto=100",
        "tedeben.rate-limit.api.capacidad=1",
        "tedeben.rate-limit.api.recarga-por-minuto=1"
})

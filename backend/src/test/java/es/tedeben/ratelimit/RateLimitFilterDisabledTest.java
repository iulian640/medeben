...
/**
 * Con {@code tedeben.rate-limit.habilitado=false} el filtro no debe limitar
...
@TestPropertySource(properties = {
        "tedeben.rate-limit.habilitado=false",
        "tedeben.rate-limit.auth.capacidad=1",
        "tedeben.rate-limit.auth.recarga-por-minuto=1"
})

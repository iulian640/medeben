...
import es.tedeben.config.RelojConfig;
import es.tedeben.config.SecurityConfig;
import es.tedeben.controller.AuthController;
import es.tedeben.controller.GlobalExceptionHandler;
import es.tedeben.service.AuthService;
import es.tedeben.service.CredencialesInvalidasException;
...
@TestPropertySource(properties = {
        "tedeben.rate-limit.habilitado=true",
        "tedeben.rate-limit.confiar-en-proxy=false",
        "tedeben.rate-limit.auth.capacidad=2",
        "tedeben.rate-limit.auth.recarga-por-minuto=2",
        "tedeben.rate-limit.api.capacidad=5",
        "tedeben.rate-limit.api.recarga-por-minuto=5"
})

...
@TestPropertySource(properties = {
        ...
        "medeben.rate-limit.auth.capacidad=100",
        "medeben.rate-limit.auth.recarga-por-minuto=100",
        "medeben.rate-limit.api.capacidad=1",
        "medeben.rate-limit.api.recarga-por-minuto=1"
})
